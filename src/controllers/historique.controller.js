...
const createHistorique = async (req, res) => {
  ...
  // Retour d'une réponse avec le statut 201 (Créé) et les données de l'historique créé
  return res.status(201).json({ message: "OK", historiques: result });
};
...
// Exportation de l'objet contenant toutes les fonctions du contrôleur des historiques
